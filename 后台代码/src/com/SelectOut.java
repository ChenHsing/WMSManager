...
import static sql.sqlconnect.GetOutName;
import static sql.sqlconnect.SQLconnect;
import static sql.sqlconnect.getOutCage;
...
/**
 * Servlet implementation class SelectOut
 */
@WebServlet("/api/outname")
public class SelectOut extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			resultSet = getOutCage(gname,start,end);
		} catch (Exception e) {
	...
	private String toString2() {
        ...
        try {
            while(resultSet.next()){
                ...
                test.put("price",resultSet.getDouble("out_price"));
                test.put("amount",resultSet.getInt("out_amount"));
                test.put("time", resultSet.getString("out_time"));
                test.put("total_price", resultSet.getString("total_price"));
